...
const enConfig = {
  ...
  themeConfig: {
    nav: [
      ...
      { text: 'API Reference', link: '/en/api/core' },
      ...
      '/en/api/': [
        {
          ...
          items: [
            ...
            { text: 'Utilities', link: '/en/api/utilities' }
          ]
        }
      ],
      '/en/examples/': [
        {
          ...
          items: [
            ...
            { text: 'Advanced Patterns', link: '/en/examples/advanced' }
          ]
        }
      ],
      '/en/development/': [
...
const zhConfig = {
  ...
  themeConfig: {
    ...
    editLink: {
      pattern: 'https://github.com/yourusername/industryts/edit/main/py-industryts/docs/:path',
      text: '在 GitHub 上编辑此页'
    }
  }
}
...
export default defineConfig({
  title: 'Industryts Python API',
  description: '工业数据的高性能时间序列处理库 - Python API 文档',
