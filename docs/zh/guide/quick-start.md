...
详细安装说明请参阅[安装指南](/zh/guide/installation)。
...
[了解更多关于 fill_null](/zh/guide/cleaning#fill-null)
...
[了解更多关于滞后特征](/zh/guide/features#lag-features)
...
[了解更多关于标准化](/zh/guide/transforms#standardization)

## 操作状态

| 操作 | 状态 | 文档 |
|-----------|--------|---------------|
| fill_null | ✅ 已实现 | [指南](/zh/guide/cleaning#fill-null) |
| lag | ✅ 已实现 | [指南](/zh/guide/features#lag-features) |
| standardize | ✅ 已实现 | [指南](/zh/guide/transforms#standardization) |
| resample | 🚧 等待 Polars 0.51 API | [指南](/zh/guide/time-ops#resample) |
| rolling | 📋 计划中 | 即将推出 |
...
- **[核心概念](/zh/guide/concepts/timeseries)** - 理解 TimeSeriesData 和 Pipeline
- **[数据清洗](/zh/guide/cleaning)** - 掌握缺失值处理
- **[特征工程](/zh/guide/features)** - 创建强大的滞后特征
- **[TOML 配置](/zh/guide/toml/structure)** - 构建声明式流程
- **[API 参考](/zh/api/timeseries)** - 完整的 API 文档
- **[示例](/zh/examples/basic)** - 真实世界的用例
...
- **文档**: [完整用户指南](/zh/guide/loading-data)
- **示例**: [真实世界示例](/zh/examples/basic)
